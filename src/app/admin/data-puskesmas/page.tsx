    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between gap-4">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-gradient-to-br from-blue-500 to-cyan-400 text-white rounded-lg hover:opacity-90 transition-opacity"
          >
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
        <div className="flex gap-4">
          ...
          <div>
            <h3 className="font-semibold text-gray-900 mb-2">Informasi Data Puskesmas</h3>
          ...
          <div className="bg-white p-6 rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="mb-4">
              <InteractiveMap
                ...
                onSourceClick={(source) => {
                  ...
                  console.log("Peta diklik:", source);
                }}
              />
              ...
              <div className="space-y-3">
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <div className="mt-1 p-2 bg-gray-50 rounded border">{selected.nama}</div>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-700">Email</label>
                    <div className="mt-1 p-2 bg-gray-50 rounded border">{selected.email}</div>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-700">Telepon</label>
                    <div className="mt-1 p-2 bg-gray-50 rounded border">{selected.phone}</div>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-700">Kecamatan</label>
                    <div className="mt-1 p-2 bg-gray-50 rounded border">{selected.kecamatan}</div>
                  </div>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-700">Alamat</label>
                  <div className="mt-1 p-2 bg-gray-50 rounded border">{selected.alamat}</div>
                </div>
                <div className="flex items-center gap-2">
            ...
            {modal !== "detail" && (
              <button
                ...
                className="w-full mt-4 px-4 py-3 bg-gradient-to-br from-blue-500 to-cyan-400 text-white rounded-lg hover:opacity-90 transition-opacity font-medium"
              >
                {modal === "add" ? "Tambah Puskesmas" : "Simpan Perubahan"}
              </button>
            )}
          </div>
        </div>
